...
var portName = '/dev/tty.usbmodem14501';    // fill in your serial port name here
...
function draw(){
  ...
  text("srtnig: " + String(inData), 30, 50);
}
...
function serialEvent() {
  ...
  if(serialLine.length > 0){
    ...
    if(packet.type == "touchpad"){
      inData = packet.type + " " + packet.id; //byteshiften mask etc
      print(inData);
    }
  }
